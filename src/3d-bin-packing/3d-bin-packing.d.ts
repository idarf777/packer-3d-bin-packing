...
declare namespace bws.packer {
    ...
    namespace protocol {
        ...
        class EntityArray<T> extends std.Vector<T> implements IEntity {
            key(): any;
            addEventListener(type: string, listener: Function, thisArg?: any): void;
            removeEventListener(type: string, listener: Function, thisArg?: any): void;
        }
        class EntityArrayCollection<T> extends std.Vector<T> implements IEntity {
            key(): any;
            addEventListener(type: string, listener: Function, thisArg?: any): void;
            removeEventListener(type: string, listener: Function, thisArg?: any): void;
        }
        class EntityDeque<T> extends std.Deque<T> implements IEntity {
            key(): any;
            addEventListener(type: string, listener: Function, thisArg?: any): void;
            removeEventListener(type: string, listener: Function, thisArg?: any): void;
        }
